...
- novelty: whether the idea is meaningfully new compared with existing work
- excitement: whether the idea is interesting and worth pursuing
- feasibility: whether the idea can realistically be implemented and evaluated
- expected_effectiveness: whether the idea is likely to improve target metrics or produce useful findings
- overall: holistic research idea quality

Additional workflow-specific dimensions:
- baseline_grounding: concrete relation to direct baselines and their weaknesses
- experimental_rigor: metrics, ablations, negative controls, success/failure criteria
