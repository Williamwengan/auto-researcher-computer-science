...
```bash
python -m researcharena.cli run --config configs/default.yaml --resume outputs/pipeline_bridge_from_focused_ideas_v1/physical_property/idea_01
```
