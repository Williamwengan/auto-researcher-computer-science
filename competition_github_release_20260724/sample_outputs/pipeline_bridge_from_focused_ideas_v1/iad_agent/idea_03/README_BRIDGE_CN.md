# Bridge Workspace 03: 工业异常检测 IAD + Agent
...
```bash
python -m researcharena.cli run --config configs/default.yaml --resume outputs/pipeline_bridge_from_focused_ideas_v1/iad_agent/idea_03
```
