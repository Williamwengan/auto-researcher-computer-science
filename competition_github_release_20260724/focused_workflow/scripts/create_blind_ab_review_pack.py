...
注意：`blind_ab_private_mapping.json` 不要给 reviewer 看。
"""
    path.write_text(content, encoding="utf-8")
...
def main() -> None:
    ...
    (output_dir / "blind_ab_private_mapping.json").write_text(
    ...
    print("Private blind mapping:", output_dir / "blind_ab_private_mapping.json")
